...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--lstm_layers', type=int, default=2, help="")
    arg_parser.add_argument('--span_attn_layers', type=int, default=2, help="")
    ...
    arg_parser.add_argument('--split_epoch', type=int, default=10, help="")
    arg_parser.add_argument('--stage_one_lr_scale', type=float, default=1.0, help="")
    

    arg_parser.add_argument('--prop_drop', type=float, default=0.1, help="Probability of dropout used in diffusent")
    arg_parser.add_argument('--soi_pooling', type=str, default="lrconcat")
    arg_parser.add_argument('--pos_type', type=str, default="sine")
    
    
    arg_parser.add_argument('--num_proposals', type=int, default=30, help="")
    ...
    arg_parser.add_argument('--timesteps', type=int, default=1000, help="")
    ...
    arg_parser.add_argument('--model_type', type=str, default="diffusent", help="Type of model")
    ...
    # Misc
    arg_parser.add_argument('--seed', type=int, default=488, help="Seed")
    ...
    #ABSA
    arg_parser.add_argument("--bert_model", default="bert-base-uncased", type=str,
                        help="Batch size per GPU/CPU for training.")
    arg_parser.add_argument("--train_batch_size", default=16, type=int, help="Batch size per GPU/CPU for training.")
    # arg_parser.add_argument("--learning_rate", default=5e-5, type=float, help="The initial learning rate for AdamW.")
    # arg_parser.add_argument("--weight_decay", default=1e-2, type=float, help="The initial learning rate for AdamW.")
    arg_parser.add_argument("--warmup_proportion", default=0.1, type=float, help="The initial learning rate for AdamW.")
    arg_parser.add_argument("--train_path", default="./DiffuSent/data/15res", type=str, help="The path of train set.")
    arg_parser.add_argument("--dev_path", default="./DiffuSent/data/15res", type=str, help="The path of dev set.")
    arg_parser.add_argument("--test_path", default="./DiffuSent/data/15res", type=str, help="The path of dev set.")
    arg_parser.add_argument("--save_dir", default='./DiffuSent/checkpoint', type=str,
                        help="The output directory where the model checkpoints will be written.")
    arg_parser.add_argument("--max_seq_len", default=128, type=int,
                        help="The maximum input sequence length. Sequences longer than this will be split automatically.")
    arg_parser.add_argument("--num_epochs", default=100, type=int, help="Total number of training epochs to perform.")
    arg_parser.add_argument("--logging_steps", default=30, type=int, help="The interval steps to logging.")
    arg_parser.add_argument("--valid_steps", default=50, type=int,
                        help="The interval steps to evaluate model performance.")
    arg_parser.add_argument("--init_from_ckpt", default=None, type=str,
...
def train_argparser():
    ...
    arg_parser.add_argument('--repeat_gt_entities', type=int, default=30, help="")
