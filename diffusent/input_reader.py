...
from diffusent.entities import Dataset, EntityType, Entity, Document, DistributedIterableDataset
...
class JsonInputReader(BaseInputReader):
    ...
    def _parse_tokens(self, jtokens, ltokens, rtokens, dataset):
        ...
        doc_encoding = [self._tokenizer.convert_tokens_to_ids(special_tokens_map['cls_token'])] #加CLS
        seg_encoding = [1]
        ...
        #切词 doc_token=[Xinhua, News, Agency] 0：Xinhua:span:(1，3) 1：News:span:(4,4)
        # doc_encoding:[101,20802,15624,6718,3128,5571]
        # seg_encoding=[1,1,1,1,1,1]
    ...
    def _parse_entities(self, jentities, doc_tokens, dataset) -> List[Entity]:
        ...
        return entities
    #entities: [Xinhua News Agency] -> (0,2) -> ORG, Canberra -> (4,4) -> GPE